...
from codesieve.report import render_scan_report, report_to_json
...
@click.option("--format", "fmt", type=click.Choice(["terminal", "json"]), default=None, help="Output format")
...
def scan_cmd(path: str, fmt: str | None, deterministic: bool, fail_under: float | None,
             sieves: str | None, config_path: str | None):
